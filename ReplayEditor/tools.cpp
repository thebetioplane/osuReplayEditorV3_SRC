...
void tool::Sel_apply(ToolState& s)
{
	...
	if (new_mark_in == -1 || new_mark_out == -1)
		return;
...
static void do_weight(const tool::ToolState &s, const glm::vec2& a, const glm::vec2& b, const I64 start, const I64 end, const I64 k_start, const bool rev)
{
	float d = 0.f;
